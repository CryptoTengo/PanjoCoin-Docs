...
pragma solidity 0.8.24; // Рекомендуется использовать стабильную версию 0.8.24 для Cancun
...
contract HybridAirdrop is Ownable, ReentrancyGuard, Pausable {
    ...
    function _getUnvestedAmount(Allocation memory alloc) private view returns (uint256 unvested_) {
        ...
        // Ограничиваем значением revocableAmount на случай частичных отзывов
